...
- [x] 1. Update IntegrationProvider type and add deprecation types in shared package
  - [x] 1.1 Update IntegrationProvider union type in packages/shared/src/index.ts
  ...
  - [x] 1.2 Add DeprecatedIntegrationProvider and AnyIntegrationProvider types
...
- [x] 2. Update integrationCatalog array in integrations package
  - [x] 2.1 Remove schoology and infinite_campus entries from packages/integrations/src/index.ts
    - Delete the schoology catalog item object
    - Delete the infinite_campus catalog item object
    - _Requirements: 1.1, 2.1_
  - [x] 2.2 Add email and calendar entries to integrationCatalog
...
- [x] 3. Add deprecation utility functions
  - [x] 3.1 Add isActiveProvider type guard to packages/integrations/src/index.ts
    ...
    - _Requirements: 8.2_
  - [x] 3.2 Add isDeprecatedProvider type guard to packages/integrations/src/index.ts
...
- [x] 4. Checkpoint - Verify compilation and connector stubs
...
- [x] 5. Add UI filtering logic for deprecated providers
  - [x] 5.1 Add connection filtering helper to integrations package
    ...
    - _Requirements: 8.4_
  - [x] 5.2 Update any UI integration list rendering to use the filter
    - Locate UI components that display integration connections
    - Apply filtering so only active catalog providers are displayed
    - _Requirements: 8.4_

- [x] 6. Write unit tests for catalog update
  - [x] 6.1 Write unit tests for integrationCatalog contents
  ...
  - [x] 6.2 Write unit tests for isActiveProvider and isDeprecatedProvider
  ...
  - [x] 6.3 Write unit tests for createMockConnector with new providers
  ...
  - [x] 6.4 Write property tests for catalog invariants
