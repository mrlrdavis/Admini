...
- [x] 1. Create CustomInstallButton component
  - [x] 1.1 Create component file at apps/web/src/components/CustomInstallButton.tsx
  ...
  - [x] 1.2 Implement dismissal persistence with localStorage
  ...
  - [x] 1.3 Implement responsive placement logic
...
- [x] 2. Add entrance animation and styling
  - [x] 2.1 Create CSS styles using AdminI design tokens
  ...
  - [x] 2.2 Implement entrance animation with reduced-motion support
...
- [x] 3. Add accessibility features
  - [x] 3.1 Add ARIA labels and keyboard navigation
